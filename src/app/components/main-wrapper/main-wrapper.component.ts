...
export class MainWrapperComponent {
  ...
  alumnos: Alumno[] = [
    ...
    { id: 6, nombre: 'Federico', apellido: 'Azcuenaga', edad: 21, estado: true },
    { id: 7, nombre: 'Constanza', apellido: 'Carballo', edad: 28, estado: true },
  ];

dataSource: MatTableDataSource<Alumno> = new MatTableDataSource<Alumno>(
    this.alumnos
  );
  columnas: string[] = ['nombreYApellido', 'edad', 'estado', 'cambioEstado'];
